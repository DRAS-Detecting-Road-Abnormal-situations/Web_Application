...
var now_loc = [37.498095, 127.02761]; // map3의 현재 위치
...
function check_5km(loc, cctv_id_x, cctv_id_y, type, image_name) {
  var dis = getDistanceFromLatLonInKm(loc[1], loc[2], cctv_id_x, cctv_id_y);
  if (dis <= 5) {
    raise_notification(type);
  }
}
